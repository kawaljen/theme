...
-->
			<div id="social-holder">
				<div class="extra-socials">
					<a href="<?php echo esc_url( get_permalink() ); ?>" data-image="<?php echo urlencode(mis_get_featured_post_image('random',$size,get_the_title(),get_the_title(),true, true)); ?>" 
							data-desc="<?php echo get_the_title(); ?>" class="btnPinIt icon-pinterest2">
							<span>Pinterest</span>
					</a> 
				</div>
			</div>
